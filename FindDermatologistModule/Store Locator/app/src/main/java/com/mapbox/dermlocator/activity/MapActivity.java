package com.mapbox.dermlocator.activity;
...
import com.mapbox.dermlocator.R;
import com.mapbox.dermlocator.adapter.LocationRecyclerViewAdapter;
import com.mapbox.dermlocator.model.IndividualLocation;
import com.mapbox.dermlocator.util.LinearLayoutManagerWithSmoothScroller;
...
import static com.mapbox.dermlocator.util.StringConstants.SELECTED_THEME;
...
public class MapActivity extends AppCompatActivity implements LocationRecyclerViewAdapter.ClickListener {
  ...
  private static final LatLng MOCK_DEVICE_LOCATION_LAT_LNG = new LatLng(40.521677, -74.462347);
    ...
    private void initializeTheme() {
      switch (selectedTheme) {
        case R.style.AppTheme_Blue:
          ...
          selectedMarkerIcon = IconFactory.getInstance(context).fromResource(R.drawable.white_unselected_house);
